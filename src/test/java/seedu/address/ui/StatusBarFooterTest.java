...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    private static final FilteredListChangedEvent FILTERED_LIST_EVENT_STUB = new FilteredListChangedEvent(
            new FilteredList<>(FXCollections.observableArrayList(Collections.singletonList(ALICE))));
    ...
    public void display() {
        ...
        postNow(EVENT_STUB);
        postNow(FILTERED_LIST_EVENT_STUB);
