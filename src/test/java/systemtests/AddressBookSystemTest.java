...
public abstract class AddressBookSystemTest {
    ...
    /**
     * Asserts that only the total persons was changed to match the total number of persons in the filtered list,
     * while the syn status and the save location remains the same.
     */
    protected void assertStatusBarUnchangedExceptTotalPersons() {
        StatusBarFooterHandle handle = getStatusBarFooter();
        assertFalse(handle.isSaveLocationChanged());

        final int totalPersons = testApp.getModel().getFilteredPersonList().size();
     ...
     * number of persons in the filtered list, while the save location remains the same.
     */
